...
exports.copyPackageToStore = function (pkg, options) { return __awaiter(void 0, void 0, void 0, function () {
    var workingDir, _a, devMod, copyFromDir, storePackageStoreDir, ignoreFileContent, ignoreRule, npmList, filesToCopy, copyFilesToStore, hashes, _b, signature, publishedSig, versionPre, pkgToWrite;
        ...
        switch (_c.label) {
            ...
            case 8:
                ...
                versionPre = options.signature
                    ...
                    : '';
                pkgToWrite = __assign(__assign({}, (devMod ? modPackageDev(pkg) : pkg)), { yalcSig: signature, version: pkg.version + versionPre });
