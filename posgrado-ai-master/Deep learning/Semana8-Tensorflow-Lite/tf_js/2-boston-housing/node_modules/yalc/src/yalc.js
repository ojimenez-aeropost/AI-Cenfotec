...
var getPublishOptions = function (argv, override) {
    ...
    var folder = argv._[1];
    return __assign({ workingDir: path_1.join(process.cwd(), folder || ''), push: argv.push, replace: argv.replace, signature: argv.sig, changed: argv.changed, files: argv.files, private: argv.private, scripts: argv.scripts, update: argv.update || argv.upgrade }, override);
};
...
yargs_1.default
    ...
    builder: function () {
        return yargs_1.default.boolean(__spreadArrays(updateFlags)).help(true);
    },
    handler: function (argv) {
